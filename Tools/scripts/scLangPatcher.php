...
// ES (Spanis) || EN (English)
$language = "en";

$crearLogs = true;                  // CREATE LOGS FILE ¿?

$rutaCompleta = "/../../data/Localization/english/";

$archivoOriginal = $rutaCompleta . "global.ini";    // ORIGINAL / OLD INI FILE
$archivoNuevo = $rutaCompleta . "global.new.ini";   // NEW PATCH INI FILE
$archivoFinal = $rutaCompleta . "global.final.ini"; // FINAL INI FILE (WITH ALL CHANGES)
